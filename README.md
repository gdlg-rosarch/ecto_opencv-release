...
## ecto_opencv (kinetic) - 0.7.0-0

The packages in the `ecto_opencv` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --track kinetic --rosdistro kinetic ecto_opencv` on `Sun, 24 Apr 2016 09:53:36 -0000`
...
## ecto_opencv (jade) - 0.6.1-0

The packages in the `ecto_opencv` repository were released into the `jade` distro by running `/usr/bin/bloom-release --track jade --rosdistro jade ecto_opencv` on `Mon, 31 Aug 2015 19:51:43 -0000`
...
## ecto_opencv (indigo) - 0.6.1-0

The packages in the `ecto_opencv` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --track indigo --rosdistro indigo ecto_opencv` on `Mon, 31 Aug 2015 19:49:23 -0000`
